...
bot.on("ready", async () => {
    console.log(`\u001b[32m
     ...
     ▄▄█ █▄▄ ▀▄▀  █     █  █ ▀▄▄ █ █ █▄▄  █  ▄██
               ...
               \u001b[0m `);
    console.log("\u001b[32m BoT Online \n\u001b[0m" + "\u001b[35m Activity Set To Streaming!\u001b[0m \n" + "\u001b[31m Bot Name: " + bot.user.username + "\u001b[0m \n" + "\u001b[31m Bot ID:" + bot.user.id + "\u001b[0m \n" ); 
    console.log("\u001b[32m▶▷ \u001b[0m\u001b[0m\u001b[40;1m\u001b[34;1mBot Ready!\u001b[0m \u001b[32m◁◀ \u001b[0m");
    await bot.editStatus("online", {
        name: process.env["status"] || "By 3loy DeV",
        type: 1,
        url: "https://www.twitch.tv/3loy105"
    });
...
for (let i = 1; i <= 5; i++) {
    if (options.some(e => e.name == `button_name_${i}`) && options.some(e => e.name == `support_role_${i}`)) {
        ...
        components.push({
            ...
            emoji: { id: '1302756938261725185', name: 'ticket' } // Ensure this line is correctly formatted
        });
    }
};
